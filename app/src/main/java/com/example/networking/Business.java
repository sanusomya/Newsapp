...
public class Business extends AppCompatActivity {
    ...
    static final String A = "https://newsapi.org/v2/top-headlines?country=in&category=business&apiKey=65b60fe858bc4714b99452ec6d4f7414";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                if(response.isSuccessful()){
                    ...
                    Business.this.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            create(json);
        ...
        bottomNavigationView.setSelectedItemId(R.id.bottom_business);
